...
<1>2 MoneyTotalPreserved' BY DEF MoneyTotalPreserved, Imbalance,
    CreditTotal, DebitTotal, AmountPendingTotal, MapThenSumSet, MapThenFoldSet,
    creditBal, debitBal, transAmount, transPending, AmountIsPending,
    IndInv, TypeOK, pcLabels
<1>3 \A t \in Transfer: pc[t]' \notin {"choose_accounts"} <=> NonEmptyAccounts(t)'
